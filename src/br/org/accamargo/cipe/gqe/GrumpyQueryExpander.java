...
public class GrumpyQueryExpander {
	...
	public GrumpyQueryExpander(String ontocloudOntology, String ocNS, String domainOntology, String dmNS ) {
		...
		// @TODO hack para resolver o import
		dm.addAltEntry("http://www.cipe.accamargo.org.br/ontologias/estudo_clinico.owl", this.domainOntology);
	...
	public String createQueryFromClasses( List<String> list ) throws Exception {
		...
		// inicia construção da árvore sintática
		...
		while( it.hasNext() ) {
			...
			if ( subclasses != null ) {
				...
				while( subclassesIterator.hasNext()) {
					...
					{
						throw new Exception("Não sei lidar com isso: "+ontSubClass.getRDFType());
					}
	...
	/**
	 * retorna um OpService referenciando o endpoint específico com uma
	 * tripla do tipo
	...
	/**
	 * Retorna um Array de classes que compõe a interseção; se não 
	...
	/**
	 * retorna classes definidas na ontologia de domínio
	 * 
